...
model = LightningModel.load_from_checkpoint('/home/charanarikala/rjac-edge-ai-innovation/experiments/exp02/logs/fcn_exp_02/version_73/checkpoints/epoch=119-step=2040.ckpt', cfg=cfg)
model.eval()
...
for idx, (i, o) in enumerate(test_loader, 0):
    ...
    save_pth = os.path.join('/home/charanarikala/rjac-edge-ai-innovation/experiments/exp02/Results/photo/' , save_id)
